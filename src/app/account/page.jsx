import { User, Lock, Settings, MoveLeft } from 'lucide-react';

export default function AccountPage() {
    return (
        <div className="mt-[70px] flex justify-center items-center p-5">
            <div className="w-full max-w-[1300px]">
                <a href='/home' className='flex items-center gap-2 text-gray-600 hover:text-gray-700 duration-300 group'>
